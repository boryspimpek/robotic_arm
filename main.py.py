...
def main():
    ...
    move_to_point(current_position, method, orientation_mode, max_speed=500)
    ...
    try:
        while True:
            ...
            if triangle == 1 and button_states[TRIANGLE_BUTTON_ID] == 0:
                ...
                move_to_point(current_position, method, orientation_mode)
            ...
            if new_position != current_position:
                try:
                    move_to_point(new_position, method, orientation_mode)
