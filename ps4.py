...
class ArmPS4Controller(Controller):
    def __init__(self, **kwargs):
        ...
        self.arm.move_to_point_simple((self.x, 0.0, self.z), tempo_dps=60)
    ...
    def update_position(self, delta_x, delta_z, delta_phi, z_thresholds):
        ...
        if self.arm.pad_ik_simple(new_x, new_z, new_phi, wrist_horizontal=self.wrist_horizontal):
    ...
    def calculate_new_x(self, delta_x, z_thresholds):
        x_limit = 38.0 if not self.wrist_horizontal and self.z < 122 else 0.0 
